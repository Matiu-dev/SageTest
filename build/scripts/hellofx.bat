...
set CLASSPATH=%APP_HOME%\lib\hellofx.jar;%APP_HOME%\lib\News-API-Java-1.0.0.jar;%APP_HOME%\lib\converter-gson-2.4.0.jar;%APP_HOME%\lib\retrofit-2.4.0.jar;%APP_HOME%\lib\gson-2.8.2.jar;%APP_HOME%\lib\javafx-fxml-16-win.jar;%APP_HOME%\lib\javafx-controls-16-win.jar;%APP_HOME%\lib\javafx-controls-16.jar;%APP_HOME%\lib\javafx-graphics-16-win.jar;%APP_HOME%\lib\javafx-graphics-16.jar;%APP_HOME%\lib\javafx-base-16-win.jar;%APP_HOME%\lib\javafx-base-16.jar;%APP_HOME%\lib\okhttp-3.10.0.jar;%APP_HOME%\lib\okio-1.14.0.jar

@rem Execute hellofx
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HELLOFX_OPTS%  -classpath "%CLASSPATH%" org.openjfx.MainApp %CMD_LINE_ARGS%
